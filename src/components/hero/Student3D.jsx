...
// ------------------------------------------------------------------
// Student3D — "Aarav", a premium stylised 3D graduate.
//
// Built from zero as real 3D (react-three-fiber), NOT a flat cartoon:
//   • proper human proportions (no oversized head, no bug eyes)
//   • natural skin tone, modern haircut, clean face
//   • premium graduation gown + cap, white shirt, gold tie, formal shoes
//   • fully rigged: blink, breathe, head + iris track the user's cursor,
//     syllable-synced jaw lipsync, brow emotions, natural smile,
//     confident chapter gestures, wave, and a success-celebration hop
//   • stylised-Pixar look (not photorealism) → zero uncanny valley
//   • soft warm key light + cyan/violet rim light = premium studio grade
//
// Every motion is damped (THREE.MathUtils.damp) → smooth, 60 FPS.
// ------------------------------------------------------------------
...
// ---- gown skirt profile (radius, y) bottom → top ----
const SKIRT_POINTS = [
        ...
        <group position={[0, 0.76, 0]}>
          <group ref={headTrackRef}>
            <group ref={headBobRef}>
              ...
              {/* ---- eyes (flat premium iris discs — no bug-eye bulge) ---- */}
